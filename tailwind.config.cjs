module.exports = {
  content: ['./src/**/*.{html,js,svelte,ts,md}', './node_modules/@svelteness/kit-docs/client/**/*.svelte'],
  darkMode: 'class',
  theme: {
    screens: {
      420: '420px',
  ...
  plugins: [require('@tailwindcss/forms'), require('@tailwindcss/typography'), kitDocsVariants]
};
