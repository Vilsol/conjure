var Es=Object.defineProperty,fs=Object.defineProperties;var us=Object.getOwnPropertyDescriptors;var es=Object.getOwnPropertySymbols;var Ds=Object.prototype.hasOwnProperty,ds=Object.prototype.propertyIsEnumerable;var ts=(l,s,n)=>s in l?Es(l,s,{enumerable:!0,configurable:!0,writable:!0,value:n}):l[s]=n,W=(l,s)=>{for(var n in s||(s={}))Ds.call(s,n)&&ts(l,n,s[n]);if(es)for(var n of es(s))ds.call(s,n)&&ts(l,n,s[n]);return l},X=(l,s)=>fs(l,us(s));import{S as ns,i as as,s as ls,w as J,k as _,e as g,t as x,x as O,m as w,c as h,a as k,h as z,d as r,y as I,g as E,M as m,j as V,q as R,o as j,B as M,a5 as Bs,_ as ps,a9 as cs,l as K,aa as gs,E as P,b as G,a8 as hs}from"../../../chunks/index-9bffbb89.js";import{F as Cs,B as ms,s as H,n as bs}from"../../../chunks/base-20d7510c.js";import{f as $s}from"../../../chunks/scroll-4d474ca9.js";import{C as rs}from"../../../chunks/CodeFence-4a2f990a.js";import{L as ys}from"../../../chunks/Link-dae17348.js";import"../../../chunks/singletons-4999ee60.js";import"../../../chunks/contexts-904695ee.js";import"../../../chunks/clsx.m-bc8192c6.js";function vs(l){let s,n,o,t=JSON.stringify(l[0],null,4)+"",B,e;return s=new Cs({props:{form:l[1]}}),{c(){J(s.$$.fragment),n=_(),o=g("pre"),B=x(t)},l(p){O(s.$$.fragment,p),n=w(p),o=h(p,"PRE",{});var c=k(o);B=z(c,t),c.forEach(r)},m(p,c){I(s,p,c),E(p,n,c),E(p,o,c),m(o,B),e=!0},p(p,[c]){(!e||c&1)&&t!==(t=JSON.stringify(p[0],null,4)+"")&&V(B,t)},i(p){e||(R(s.$$.fragment,p),e=!0)},o(p){j(s.$$.fragment,p),e=!1},d(p){M(s,p),p&&r(n),p&&r(o)}}}function _s(l,s,n){let o;const t=ms.newForm([{type:"input",name:"name",label:"Name",schema:H(),params:{placeholder:"Name"}},{type:"textarea",name:"description",label:"Description",schema:H(),params:{placeholder:"Description"}},{type:"input",name:"dob",label:"Date of birth",schema:H(),params:{type:"date"}},{type:"input",name:"password",label:"Password",schema:H().min(16),params:{type:"password",placeholder:"Password"}},{type:"input",name:"level",label:"Level",schema:bs().min(3).max(100),params:{type:"number",placeholder:"Level"}},{type:"select",name:"selection",label:"Option",schema:H(),hide:e=>!("level"in e&&typeof e.level=="number"&&e.level>0),options:async e=>{let p=3;return"level"in e&&typeof e.level=="number"&&e.level>0&&(p=e.level),p=Math.min(50,p),new Promise(c=>{c(Array(p).fill(0).map((u,f)=>({label:"I: "+f,value:f})))})}},{type:"button",text:"Set name to John",click:()=>B.set(X(W({},Bs(B)),{name:"John"})),params:{class:"demo-button mr-1"}},{type:"button",text:"Set level to 10",click:()=>B.set(X(W({},Bs(B)),{level:10})),params:{class:"demo-button"}}]),B=t.getData();return ps(l,B,e=>n(0,o=e)),[o,t,B]}class ws extends ns{constructor(s){super(),as(this,s,_s,vs,ls,{})}}const os="https://www.dnd5eapi.co/api";let Y;const Z={},ss={},xs=async()=>(Y||(Y=await fetch(os+"/classes").then(l=>l.json())),Y),zs=async l=>(l in Z||(Z[l]=await fetch(os+"/classes/"+l+"/features").then(s=>s.json())),Z[l]),ks=async l=>{if(l)return l in ss||(ss[l]=await fetch(os+"/features/"+l).then(s=>s.json())),ss[l]};function Fs(l,s,n){const o=l.slice();return o[5]=s[n],o}function Ss(l){return{c:P,l:P,m:P,p:P,d:P}}function Ns(l){let s,n=l[4]&&As(l);return{c(){n&&n.c(),s=K()},l(o){n&&n.l(o),s=K()},m(o,t){n&&n.m(o,t),E(o,s,t)},p(o,t){o[4]?n?n.p(o,t):(n=As(o),n.c(),n.m(s.parentNode,s)):n&&(n.d(1),n=null)},d(o){n&&n.d(o),o&&r(s)}}}function As(l){let s,n,o,t,B,e=l[4].name+"",p,c,u,f,T,L,D,S=l[4].level+"",b,d,$,N=l[4].desc,C=[];for(let y=0;y<N.length;y+=1)C[y]=is(Fs(l,N,y));return{c(){s=g("div"),n=g("strong"),o=x("Name:"),t=_(),B=g("span"),p=x(e),c=g("br"),u=_(),f=g("strong"),T=x("Level:"),L=_(),D=g("span"),b=x(S),d=g("br"),$=_();for(let y=0;y<C.length;y+=1)C[y].c();this.h()},l(y){s=h(y,"DIV",{});var i=k(s);n=h(i,"STRONG",{});var F=k(n);o=z(F,"Name:"),F.forEach(r),t=w(i),B=h(i,"SPAN",{class:!0});var v=k(B);p=z(v,e),v.forEach(r),c=h(i,"BR",{}),u=w(i),f=h(i,"STRONG",{});var a=k(f);T=z(a,"Level:"),a.forEach(r),L=w(i),D=h(i,"SPAN",{class:!0});var A=k(D);b=z(A,S),A.forEach(r),d=h(i,"BR",{}),$=w(i);for(let q=0;q<C.length;q+=1)C[q].l(i);i.forEach(r),this.h()},h(){G(B,"class","text-neutral-300"),G(D,"class","text-neutral-300")},m(y,i){E(y,s,i),m(s,n),m(n,o),m(s,t),m(s,B),m(B,p),m(s,c),m(s,u),m(s,f),m(f,T),m(s,L),m(s,D),m(D,b),m(s,d),m(s,$);for(let F=0;F<C.length;F+=1)C[F].m(s,null)},p(y,i){if(i&1&&e!==(e=y[4].name+"")&&V(p,e),i&1&&S!==(S=y[4].level+"")&&V(b,S),i&1){N=y[4].desc;let F;for(F=0;F<N.length;F+=1){const v=Fs(y,N,F);C[F]?C[F].p(v,i):(C[F]=is(v),C[F].c(),C[F].m(s,null))}for(;F<C.length;F+=1)C[F].d(1);C.length=N.length}},d(y){y&&r(s),hs(C,y)}}}function is(l){let s,n=l[5]+"",o;return{c(){s=g("p"),o=x(n),this.h()},l(t){s=h(t,"P",{class:!0});var B=k(s);o=z(B,n),B.forEach(r),this.h()},h(){G(s,"class","text-neutral-300")},m(t,B){E(t,s,B),m(s,o)},p(t,B){B&1&&n!==(n=t[5]+"")&&V(o,n)},d(t){t&&r(s)}}}function Ps(l){return{c:P,l:P,m:P,p:P,d:P}}function qs(l){let s,n,o,t,B;s=new Cs({props:{form:l[1]}});let e={ctx:l,current:null,token:null,hasCatch:!1,pending:Ps,then:Ns,catch:Ss,value:4};return cs(t=l[0],e),{c(){J(s.$$.fragment),n=_(),o=K(),e.block.c()},l(p){O(s.$$.fragment,p),n=w(p),o=K(),e.block.l(p)},m(p,c){I(s,p,c),E(p,n,c),E(p,o,c),e.block.m(p,e.anchor=c),e.mount=()=>o.parentNode,e.anchor=o,B=!0},p(p,[c]){l=p,e.ctx=l,c&1&&t!==(t=l[0])&&cs(t,e)||gs(e,l,c)},i(p){B||(R(s.$$.fragment,p),B=!0)},o(p){j(s.$$.fragment,p),B=!1},d(p){M(s,p),p&&r(n),p&&r(o),e.block.d(p),e.token=null,e=null}}}function Ls(l,s,n){let o,t;const B=ms.newForm([{type:"select",name:"class",label:"Class",schema:H(),options:async()=>[{label:"Select class...",value:""},...(await xs()).results.map(p=>({label:p.name,value:p.index}))]},{type:"select",name:"feature",label:"Feature",schema:H(),hide:p=>!("class"in p&&p.class),options:async p=>"class"in p&&p.class?[{label:"Select feature...",value:""},...(await zs(p.class)).results.map(c=>({label:c.name,value:c.index}))]:[]}]),e=B.getData();return ps(l,e,p=>n(3,t=p)),l.$$.update=()=>{l.$$.dirty&8&&n(0,o=ks(t.feature))},[o,B,e,t]}class Js extends ns{constructor(s){super(),as(this,s,Ls,qs,ls,{})}}function Os(l){let s;return{c(){s=x("#")},l(n){s=z(n,"#")},m(n,o){E(n,s,o)},d(n){n&&r(s)}}}function Is(l){let s;return{c(){s=x("#")},l(n){s=z(n,"#")},m(n,o){E(n,s,o)},d(n){n&&r(s)}}}function Rs(l){let s,n=l[0].title+"",o,t,B,e=l[0].description+"",p,c,u,f,T,L,D,S,b,d,$,N,C,y,i,F,v;return f=new ys({props:{class:"header-anchor",href:"#simple-example","aria-hidden":"true",$$slots:{default:[Os]},$$scope:{ctx:l}}}),D=new ws({}),b=new rs({props:{lang:"svelte",ext:"svelte",linesCount:112,rawCode:`<script&#8203 lang="ts">
...
<span class="line"><span style="color: #ABB2BF">      </span><span style="color: #E06C75">schema</span><span style="color: #ABB2BF">: </span><span style="color: #E5C07B">zod</span><span style="color: #ABB2BF">.</span><span style="color: #61AFEF">string</span><span style="color: #ABB2BF">(),</span></span>
<span class="line"><span style="color: #ABB2BF">      </span><span style="color: #61AFEF">hide</span><span style="color: #ABB2BF">: (</span><span style="color: #E06C75; font-style: italic">data</span><span style="color: #ABB2BF">) </span><span style="color: #C678DD">=&gt;</span><span style="color: #ABB2BF"> </span><span style="color: #56B6C2">!</span><span style="color: #ABB2BF">(</span><span style="color: #98C379">&#39;level&#39;</span><span style="color: #ABB2BF"> </span><span style="color: #C678DD">in</span><span style="color: #ABB2BF"> </span><span style="color: #E06C75">data</span><span style="color: #ABB2BF"> </span><span style="color: #56B6C2">&amp;&amp;</span><span style="color: #ABB2BF"> </span><span style="color: #C678DD">typeof</span><span style="color: #ABB2BF"> </span><span style="color: #E5C07B">data</span><span style="color: #ABB2BF">.</span><span style="color: #E06C75">level</span><span style="color: #ABB2BF"> </span><span style="color: #56B6C2">===</span><span style="color: #ABB2BF"> </span><span style="color: #98C379">&#39;number&#39;</span><span style="color: #ABB2BF"> </span><span style="color: #56B6C2">&amp;&amp;</span><span style="color: #ABB2BF"> </span><span style="color: #E5C07B">data</span><span style="color: #ABB2BF">.</span><span style="color: #E06C75">level</span><span style="color: #ABB2BF"> </span><span style="color: #56B6C2">&gt;</span><span style="color: #ABB2BF"> </span><span style="color: #D19A66">0</span><span style="color: #ABB2BF">),</span></span>
...
<span class="line"></span></code></pre>`}}),$=new ys({props:{class:"header-anchor",href:"#async-example","aria-hidden":"true",$$slots:{default:[Is]},$$scope:{ctx:l}}}),y=new Js({}),F=new rs({props:{lang:"svelte",ext:"svelte",linesCount:69,rawCode:`<script&#8203 lang="ts">
  import { Base, Form } from '$lib';
  import * as zod from 'zod';
...
<span class="line"><span style="color: #ABB2BF">      </span><span style="color: #E06C75">schema</span><span style="color: #ABB2BF">: </span><span style="color: #E5C07B">zod</span><span style="color: #ABB2BF">.</span><span style="color: #61AFEF">string</span><span style="color: #ABB2BF">(),</span></span>
<span class="line"><span style="color: #ABB2BF">      </span><span style="color: #61AFEF">hide</span><span style="color: #ABB2BF">: (</span><span style="color: #E06C75; font-style: italic">data</span><span style="color: #ABB2BF">) </span><span style="color: #C678DD">=&gt;</span><span style="color: #ABB2BF"> </span><span style="color: #56B6C2">!</span><span style="color: #ABB2BF">(</span><span style="color: #98C379">&#39;class&#39;</span><span style="color: #ABB2BF"> </span><span style="color: #C678DD">in</span><span style="color: #ABB2BF"> </span><span style="color: #E06C75">data</span><span style="color: #ABB2BF"> </span><span style="color: #56B6C2">&amp;&amp;</span><span style="color: #ABB2BF"> </span><span style="color: #E5C07B">data</span><span style="color: #ABB2BF">.</span><span style="color: #E06C75">class</span><span style="color: #ABB2BF">),</span></span>
...
<span class="line"></span></code></pre>`}}),{c(){s=g("h1"),o=x(n),t=_(),B=g("p"),p=x(e),c=_(),u=g("h2"),J(f.$$.fragment),T=x(" Simple Example"),L=_(),J(D.$$.fragment),S=_(),J(b.$$.fragment),d=g("h2"),J($.$$.fragment),N=x(" Async Example"),C=_(),J(y.$$.fragment),i=_(),J(F.$$.fragment),this.h()},l(a){s=h(a,"H1",{});var A=k(s);o=z(A,n),A.forEach(r),t=w(a),B=h(a,"P",{});var q=k(B);p=z(q,e),q.forEach(r),c=w(a),u=h(a,"H2",{id:!0,tabindex:!0});var U=k(u);O(f.$$.fragment,U),T=z(U," Simple Example"),U.forEach(r),L=w(a),O(D.$$.fragment,a),S=w(a),O(b.$$.fragment,a),d=h(a,"H2",{id:!0,tabindex:!0});var Q=k(d);O($.$$.fragment,Q),N=z(Q," Async Example"),Q.forEach(r),C=w(a),O(y.$$.fragment,a),i=w(a),O(F.$$.fragment,a),this.h()},h(){G(u,"id","simple-example"),G(u,"tabindex","-1"),G(d,"id","async-example"),G(d,"tabindex","-1")},m(a,A){E(a,s,A),m(s,o),E(a,t,A),E(a,B,A),m(B,p),E(a,c,A),E(a,u,A),I(f,u,null),m(u,T),E(a,L,A),I(D,a,A),E(a,S,A),I(b,a,A),E(a,d,A),I($,d,null),m(d,N),E(a,C,A),I(y,a,A),E(a,i,A),I(F,a,A),v=!0},p(a,[A]){(!v||A&1)&&n!==(n=a[0].title+"")&&V(o,n),(!v||A&1)&&e!==(e=a[0].description+"")&&V(p,e);const q={};A&2&&(q.$$scope={dirty:A,ctx:a}),f.$set(q);const U={};A&2&&(U.$$scope={dirty:A,ctx:a}),$.$set(U)},i(a){v||(R(f.$$.fragment,a),R(D.$$.fragment,a),R(b.$$.fragment,a),R($.$$.fragment,a),R(y.$$.fragment,a),R(F.$$.fragment,a),v=!0)},o(a){j(f.$$.fragment,a),j(D.$$.fragment,a),j(b.$$.fragment,a),j($.$$.fragment,a),j(y.$$.fragment,a),j(F.$$.fragment,a),v=!1},d(a){a&&r(s),a&&r(t),a&&r(B),a&&r(c),a&&r(u),M(f),a&&r(L),M(D,a),a&&r(S),M(b,a),a&&r(d),M($),a&&r(C),M(y,a),a&&r(i),M(F,a)}}}function js(l,s,n){let o;return ps(l,$s,t=>n(0,o=t)),[o]}class Xs extends ns{constructor(s){super(),as(this,s,js,Rs,ls,{})}}export{Xs as default};
